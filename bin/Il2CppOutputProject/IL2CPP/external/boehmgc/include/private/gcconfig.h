...
#            include <features.h>
#            if defined(__GLIBC__) && __GLIBC__ >= 2 \
                || defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)
#                define SEARCH_FOR_DATA_START
#            else
                 extern char **__environ;
#                define DATASTART ((ptr_t)(&__environ))
...
#            endif
             extern int _end[];
#            define DATAEND (ptr_t)(_end)
#            if (defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)) && !defined(GC_NO_SIGSETJMP)
...
#if (defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)) && !defined(THREADS) \
...
# define DEFAULT_VDB
     ...
     || ((defined(RTEMS) || defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)) && defined(I386))) \
...
# define CAN_HANDLE_FORK
    ...
    && !defined(HURD) && !defined(PLATFORM_ANDROID) && !defined(PLATFORM_NOVA) && !defined(SN_TARGET_ORBIS)
